...
bid6 = Bid.create(price: 10, task: task4, contractor: contractor1)
bid7 = Bid.create(price: 15, task: task4, contractor: contractor2)
bid8 = Bid.create(price: 20, task: task5, contractor: contractor3)
bid9 = Bid.create(price: 25, task: task5, contractor: contractor4)
bid10 = Bid.create(price: 30, task: task3, contractor: contractor5)
